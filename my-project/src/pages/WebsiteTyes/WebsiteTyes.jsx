...
const WebsiteTyes = () => {
  return (
    <div className="mt-24">
      <h1 className="text-colorTwo font-bold text-2xl md:text-4xl text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-9 container mt-12">
        <div className="border border-colorTwo rounded-lg p-5 bg-colorTwo text-white shadow-xl">
          ...
          <div className="text-gray-300 mt-6">
            ...
            display it in real-time, static websites are pre-built and display
            ...
            database. This can improve the user experience, especially on mobile
            devices with slow internet connections. Another advantage of static
            websites is their improved security. Because they do not use
            databases or server-side scripting, they are less vulnerable to
            hacking and other security threats.
            <br />
            <br />
            In conclusion, a static website is a great choice for businesses or
            individuals who want a simple, fast, and secure website that
        ...
        <div className="border border-colorTwo rounded-lg p-5 bg-colorTwo text-white shadow-xl">
          ...
          <div className="text-gray-300 mt-6">
            ...
            today’s digital world. A well-designed website is the foundation of
            your online presence, serving as a virtual storefront that showcases
            your products, services, and brand. A professional, user-friendly,
            and SEO-friendly website not only enhances your credibility but also
            ...
            appealing and functional website is not enough. Your website must be
            optimized for search engines, mobile devices, and user experience to
            stand out from the crowd. That’s why website design services are
        ...
        <div className="border border-colorTwo rounded-lg p-5 bg-colorTwo text-white shadow-xl">
          ...
          <div className="text-gray-300 mt-6">
            ...
            seekers. Corporate websites are meticulously crafted to reflect the
            brand's personality and establish credibility, often featuring sleek
            designs, compelling content, and user-friendly interfaces. They play
            a crucial role in building brand awareness, fostering customer
            trust, and driving business growth by serving as a primary
            touchpoint for online interactions and engagements. Additionally,
            corporate websites serve as valuable platforms for promoting
            corporate social responsibility initiatives, attracting talent, and
        ...
        <div className="border border-colorTwo rounded-lg p-5 bg-colorTwo text-white shadow-xl">
          ...
          <div className="text-gray-300 mt-6">
            ...
            to a variety of information, services, and resources available on
            the internet. It typically offers users a customizable homepage with
            links to news, email, search engines, weather updates, and other
            commonly used features. Web portals often cater to specific
            interests or demographics, such as business professionals, students,
            or enthusiasts of a particular field. They aim to simplify internet
            navigation by providing a single interface where users can access a
            wide array of content and tools. Web portals may also offer
            personalized content based on user preferences, making them
            convenient hubs for accessing online resources efficiently.
          </div>
        </div>
      </div>
    </div>
